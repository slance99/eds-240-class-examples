...
ggMarginal(p2, type = "density", groupFill = TRUE, groupColor = TRUE)
...
ggplot(stream_chem_data, aes(x = SO4, y = pH)) +
  geom_density_2d_filled() #legend = proportion of all datapoints in that region

ggplot(stream_chem_data, aes(x = SO4, y = pH)) +
  ggdensity::geom_hdr() #highest density region
```
